...
Authors: "Nathan Riojas, Ryan Billa, Corey Monreal-Jackson"
...
#### R markdown code
#####Immediately below are the codes we adjusted from the R_ETL.R file to create tables. Its is directly pasted from the code because in the code it calls the csv so it cannot run if sourced.
